...
import PerformanceCard from "../../cards/performancecard/performance-card";
import MGreen from "../../assets/svg/message-green.svg";
import MWhite from "../../assets/svg/message-white.svg";
import BrowserShareChart from "../../charts/ShareChart";
  ...
  return (
    <div className="main-container-section-V">
      ...
      <div className="second-container-section-V">
        ...
        <div className="second-row-section-V">
          <p className="para-second-row fs-md fw-400">مؤشر أداء الجدول الزمني</p>
